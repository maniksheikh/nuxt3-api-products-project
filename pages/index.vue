    ...
    <div class="bg-[#fafafc] m-auto w-[1500px]">
      <div class="mt-10-blue- py-10">
        <header class="mt-10 text-center py-8 font-sans">
          <h1
            class="text-5xl font-bold leading-10 w-[540px] h-[65px] p-2 m-auto"
          >
            Product Landing page.
          </h1>
          <p class="w-[400px] p-2 m-auto mt-1 text-xl leading-5">
        ...
        <!-- payment section  -->
        <div class="bg-[#fffee7] mt-20">
          <div class="text-center w-[500px] m-auto p-3">
            <h1 class="font-bold text-3xl text-[#2e2d35]">
              Trusted by World`s Most Favourite Brands
            </h1>
          </div>
          <div class="flex mt-7 m-auto">
            <div class="flex items-center justify-between w-[70%] m-auto">
              <div
        ...
        <!-- social cart system -->
        <div
          class="flex items-center justify-between m-auto mt-20 bg-[#fffee7]"
        >
        ...
        <div>
          <div
            class="text-center lg:h-[400px] h-[300px] lg:pt-[80px] pt-[55px]"
          >
            <div>
