    ...
    <div class="p-0 sm:w-[1300px] w-[100%] m-auto">
      <div class="">
        <div class="sm:mt-10 mt-5 sm:py-16">
          <header class=" mt-10 text-center mx-auto lg:w-[1200px] w-full space-y-3 px-2 md:px-0">
            <h1
              ...
              <span class="ml-4 italic text-[#a1c3eb] opacity-90">Landing</span> page.
            </h1>
            <p
          ...
          <div class="sm:mt-10 mt-10">
            <div class="sm:flex block sm:gap-20 m-auto sm:w-[1200px]">
              <div class="sm:w-[48%] w-[100%] text-center items-center justify-center m-auto px-2 sm:px-2">
                ...
                <p
                  class="text-gray-200 leading-6 mt-3 sm:text-[18px] text-center py-1 sm:w-[490px] w-[100%] font-[400]">
              ...
              <div class="sm:w-[50%] w-[100%] sm:mt-0 mt-5 m-auto px-2 sm:px-0">
                <img class="w-full sm:h-[450px] cursor-pointer"
            ...
            <div class="bg-[#fffee7] sm:mt-32 mt-16 sm:py-10 rounded-md">
              ...
              <div class="sm:flex items-center sm:w-[800px] sm:mt-20 mt-10 m-auto">
                <Vue3Marquee :clone="true" :duration="10" :direction="'reverse'"
                  class="flex items-center sm:space-x-10 justify-between w-[65%] m-auto">
                  <div class="items-center justify-center w-[100%]">
                    <nuxt-link to="">
                      <img class="cursor-pointer"
                        ...
                        jsaction="VQAsE" style="height: 70px" alt="Google Logo PNGs for Free Download" jsname="kn3ccd"
                        aria-hidden="false" />
                    </nuxt-link>
                  </div>
                  ...
                  <div class="items-center justify-center w-[100%]">
                    <nuxt-link>
                      <img
                        ...
                        jsaction="VQAsE" class="cursor-pointer"
                        alt="bKash Logo • Download bKash vector logo SVG • Logotyp.us" jsname="JuXqh"
                        style="height: 70px" data-iml="401289.1000000015" />
                    </nuxt-link>
                  </div>
                  <div class="items-center justify-center w-[100%]">
                    <nuxt-link>
                      <svg class="h-10 cursor-pointer hover:text-gray-900 dark:hover:text-white" viewBox="0 0 124 38"
                  ...
                  <div class="items-center justify-center w-[100%]">
                    <nuxt-link>
                      <img src="https://www.logo.wine/a/logo/PayPal/PayPal-Logo.wine.svg" jsaction="VQAsE"
                        class="cursor-pointer" style="height: 70px"
                        alt="Download bKash Logo in SVG Vector or PNG File Format - Logo.wine" jsname="kn3ccd"
                        aria-hidden="false" />
                    </nuxt-link>
                  </div>
                  ...
                  <div class="items-center justify-center w-[100%]">
                    <nuxt-link>
                      <img
                        ...
                        jsaction="VQAsE" class="cursor-pointer" style="height: 70px"
                        alt="bKash relaunches digital payroll solution - The Business Post" jsname="kn3ccd"
                        aria-hidden="false" />
                    </nuxt-link>
                  </div>
                  <div class="items-center justify-center w-[100%]">
                    <nuxt-link to="">
                      <img src="https://logicoretech.com/wp-content/uploads/2021/05/ScaleLeap-logo_Full-Color.png"
                        jsaction="VQAsE" class="cursor-pointer" style="height: 70px"
                        alt="ClickUp Services – LogiCore Tech – Professional Services" jsname="kn3ccd"
                        aria-hidden="false" />
                    </nuxt-link>
                  </div>
                </Vue3Marquee>
          ...
          <div class="sm:mt-20 mt-16">
            <div class="sm:flex sm:gap-10 px-2 sm:px-0 border border-white rounded-md">
              ...
              <div class="sm:w-[50%] w-[100%] mb-5 sm:mt-0 sm:mb-0 mt-5">
                <h1 class="sm:text-[52px] text-[28px] sm:w-[500px] w-[100%] sm:p-5 p-2 font-[500] leading-tight">
          ...
          <div class="sm:mt-32 mt-16 bg-white rounded-md">
            ...
            <div class="sm:mt-12 mt-10">
              <Vue3Marquee :pause-on-hover="true" @on-pause="playState = 'paused'" @on-resume="playState = 'playing'"
                ...
                <div v-for="user in userData" :key="user.id" class="flex-none px-2">
                  <div class="h-[390px] w-[310px] gap-5 border border-gray-200 rounded-2xl overflow-hidden mx-auto">
                    <div class="p-4">
                      <div class="flex items-center">
                        <div class="w-12 h-12">
                          <img :src="user.image" alt="Malav Shah avatar"
              ...
              <div class="sm:grid sm:grid-cols-3 grid-cols-1 sm:gap-10 sm:space-y-0 space-y-5">
                <div v-for="chatSection in chatSectionData" :key="chatSection.id" :class="chatSection.class"
                  ...
                  <div class="sm:pt-14 p-10 sm:p-0 h-auto text-surface">
                    <div class="w-[48px]">
                      <img class="w-[48px] h-[48px]" decoding="async" sizes="48px" :src="chatSection.avatar" alt=""
                        style="
                        display: block;
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:pb-10 pb-5">
                    <div v-for="review in reviews.slice((slide - 1) * 3, slide * 3)" :key="review.id"
                      ...
                      <div class="flex justify-center mb-4">
                        <svg class="h-12 sm:h-14 p-3 cursor-pointer text-gray-300 dark:text-gray-600"
...
const reviews = reactive(reviewSection);
