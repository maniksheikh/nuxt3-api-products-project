<template>
  <div class="mt-20">
    <div class="p-5 mt-12">
      <div
        v-if="product"
        class="w-[500px] h-auto bg-white border border-gray-200 m-auto rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
      >
        <a href="#">
        ...
        <div class="p-5">
          <h5
            class="mb-2 text-2xl font-[600] tracking-tight text-gray-900 dark:text-white"
          >
            {{ product.title }}
          </h5>
          <h5
