<template>
  <div class="sm:mt-20 mt-20 sm:w-[1200px] m-auto sm:mb-10">
    ...
    <div v-else class="sm:grid sm:grid-cols-3 space-y-6 sm:space-y-0 sm:gap-10 sm:px-0 px-2">
      <router-link v-for="product in products" :key="product.id" :to="`/products/${product.id}`"
        ...
        <img class="sm:w-full sm:h-[320px] h-[300px] w-full mb-5 sm:mb-0 self-center object-cover" :src="product.image"
          alt="" />
